...
const Dashboard: React.FC = () => {
  ...
  const { 
    ...
    queryKey: ['dashboard', selectedCategories, dateRange],
  ...
  // Mutation for syncing Meta data
  const syncMutation = useMutation({
    mutationFn: apiClient.syncMetaData,
    onSuccess: (result) => {
      if (result.success) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Meta Ads Performance Dashboard</p>
            </div>
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 border border-border rounded-md hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-colors"
            >
